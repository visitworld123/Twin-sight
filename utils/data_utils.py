...
def average_named_params(params_list, average_weights_dict_list):
    """
        This is a weighted average operation.
    ...
    averaged_params = deepcopy(params_list[0])
#   averaged_params is the dict of all parameters
    for k in averaged_params.keys():
        for i in range(0, len(params_list)):  # model个数
            local_named_params = params_list[i]
